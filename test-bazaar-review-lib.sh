...
p=$( source "$LIB"; remediation_prompt spec 2 ); case "$p" in *"index.md"*"log.md"*"evidence"*) pass "spec remediation prompt allows index.md, log.md and support files" ;; *) fail "spec remediation prompt allows index.md and log.md" ;; esac
